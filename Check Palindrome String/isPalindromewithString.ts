function isPalindrome(s: string): boolean {
    s = s.toLowerCase().replace(/[^a-zA-Z0-9]/g,'');//Primero se indican todas las letras a minusculas y se reemplaza todos los caracteres que nosean alfanumericos por una cadena vacía 
    let left = 0;
